...
# sensitivity to bag of directions
rm(list = ls())
...
# Methods #
###########
# directions - difference from CA_daily.R
directions <- c("W", "SW", "S", "SE")                                           
...
# 
# saveRDS(out, paste0(path, "application/CA_daily_bag_v2_all.RDS"))
...
#         paste0(path, "application/CA_daily_bag_v2.RDS"))

###########
# Results #
###########
# call results
bagres <- readRDS(paste0(path, "application/CA_daily_bag_v2.RDS"))
